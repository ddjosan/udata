...
class ModelSearchAdapter:
    ...
    def as_request_parser(cls, paginate=True, store_missing: bool = True):
        ...
        # q parameter
        parser.add_argument("q", type=str, location="args", help="The search query", store_missing=store_missing)
        ...
        parser.add_argument("sort", type=str, location="args", choices=choices, help=help_msg, store_missing=store_missing,)
        if paginate:
            parser.add_argument(
