...
const less_loader = ExtractTextPlugin.extract(
  "vue-style?sourceMap",
  "css?sourceMap!less?sourceMap=source-map-less-inline"
);

const languages = ["en", "es", "fr", "pt", "sr", "sl", "de"];
...
module.exports = {
  ...
  resolve: {
    root: [__dirname, path.join(__dirname, "js")],
    alias: {
      "jquery-slimscroll": path.join(
        node_path,
